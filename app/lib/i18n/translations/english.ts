const english = {
  ...
  'playlist.privateExplanation': 'Your playlist will not be visible nor accessible by anyone.',
  ...
  'playlist.noSongsFound': 'No songs found',
  ...
  'album.removedFromLibrary': 'Album removed from your library',
  'song.removedFromLibrary': 'Song removed from your library',
  'playlist.removedFromLibrary': 'Playlist removed from your library',
  'artist.removedFromLibrary': 'Artist removed from your library',

  failedToAddToLibrary: 'Failed to add to library',
  // Artist Header
  // Media Header
