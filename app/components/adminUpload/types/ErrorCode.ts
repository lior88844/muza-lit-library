...
export const UPLOAD_ERROR_CODES = {
  [UploadErrorCodeEnum.ALL_FILES_INVALID]: {
    ...
    description: 'No FLAC files found in this folder. All files were skipped because they are not in FLAC format.',
  },
  [UploadErrorCodeEnum.PARTIAL_UPLOAD]: {
    code: UploadErrorCodeEnum.PARTIAL_UPLOAD,
    title: 'Partial Upload',
    description: 'Some files were skipped because they are not in FLAC format. Only FLAC files will be processed.',
  },
