...
const MediaCover: React.FC<MediaCoverProps> = ({ imageSrc, title, mediaType = 'album', size = 'large' }) => {
    ...
    if (Array.isArray(imageSrc) && imageSrc.length >= 4) {
      return (
        <div className='playlist-collage' data-name='Playlist Collage'>
          <div className='collage-item collage-item--top-left' style={{ backgroundImage: `url('${imageSrc[0]}')` }} />
          <div className='collage-item collage-item--top-right' style={{ backgroundImage: `url('${imageSrc[1]}')` }} />
          <div className='collage-item collage-item--bottom-left' style={{ backgroundImage: `url('${imageSrc[2]}')` }} />
          <div className='collage-item collage-item--bottom-right' style={{ backgroundImage: `url('${imageSrc[3]}')` }} />
        </div>
      )
    }
